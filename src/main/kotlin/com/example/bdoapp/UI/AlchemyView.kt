...
class AlchemyView(private val navigation: NavigationManager) {

    private val recipeScraper = RecipeScraper().apply { useAlchemyURL = true }
    ...
    private fun createRecipeListPanel(): VBox {
        ...
        val titleLabel = Label("Alchemy Recipes").apply {
            styleClass.add("section-title")
        }

        val searchField = TextField().apply {
            styleClass.add("text-field")
            promptText = "Search alchemy recipes..."
        }
    ...
    private fun createRecipeDetailsPanel(): VBox {
        ...
        resultArea = TextArea().apply {
            ...
            isEditable = false
            promptText = "Select an alchemy recipe from the list to view ingredients and calculations..."
            VBox.setVgrow(this, Priority.ALWAYS)
        }
